...
unless ApplicationHelper.included_modules.include? MultiCalendar::Patches::ApplicationHelperPatch
    ApplicationHelper.send(:include, MultiCalendar::Patches::ApplicationHelperPatch)
end
